...
const (
	VarifyService_GetVarifyCode_FullMethodName = "/message.VarifyService/GetVarifyCode"
)
...
func (c *varifyServiceClient) GetVarifyCode(ctx context.Context, in *GetVarifyReq, opts ...grpc.CallOption) (*GetVarifyRsp, error) {
	...
	err := c.cc.Invoke(ctx, VarifyService_GetVarifyCode_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
const (
	StatusService_GetChatServer_FullMethodName = "/message.StatusService/GetChatServer"
	StatusService_Login_FullMethodName         = "/message.StatusService/Login"
)
...
func (c *statusServiceClient) GetChatServer(ctx context.Context, in *GetChatServerReq, opts ...grpc.CallOption) (*GetChatServerRsp, error) {
	...
	err := c.cc.Invoke(ctx, StatusService_GetChatServer_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *statusServiceClient) Login(ctx context.Context, in *LoginReq, opts ...grpc.CallOption) (*LoginRsp, error) {
	out := new(LoginRsp)
	err := c.cc.Invoke(ctx, StatusService_Login_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _StatusService_GetChatServer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StatusService_GetChatServer_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _StatusService_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StatusService_Login_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
